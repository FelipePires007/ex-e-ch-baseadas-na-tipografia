...
Essas declarações CSS mostram como utilizar `ex` e `ch` para ajustar a altura de um parágrafo e a largura de um campo de entrada de texto com base na fonte usada.
